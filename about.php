...
<html class="no-js"> <!--<![endif]-->
	...
	<title>Joy Makers-Together, We Create! &mdash; 100% Free Fully Responsive HTML5 Template by FREEHTML5.co</title>
						...
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								...
								<ul class="fh5co-sub-menu">
									<li><a href="Donate_Now.php">Donate</a></li>
									<li><a href="fundraise.html">Fundraise</a></li>
									<li><a href="campain.html">Campaign</a></li>
									
									<li><a href="volunteer2.html">Volunteer</a></li>
								</ul>
							</li>
							<li>
								<a href="#" class="fh5co-sub-ddown">Projects</a>
								 <ul class="fh5co-sub-menu">
								 	<li><a href="water world.html">Water World</a></li>
								 	<li><a href="clothes.html">Cloth Giving</a></li>
								 	<li><a href="medical_mission.html">Medical Mission</a></li>
								</ul>
							</li>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_2.jpg);">
				<div class="desc animate-box">
					...
					<span><a class="btn btn-primary btn-lg" href="Donate_Now.php">Donate Now</a></span>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="feature-text">
							<h3>Love</h3>
							<p>You give charity for love not love for charity.</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="feature-text">
							<h3>Compassion</h3>
							<p>Compassion is to look beyond your own pain, to see the pain of others.</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="feature-text">
							<h3>Charity</h3>
							<p>Charity is begins at home, but should not end there.</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center heading-section animate-box">
						<h3>Our Gallery</h3>
						<p>
							It is very important for the customer to pay attention to the adipiscing process. If it is easy for the older ones, we accuse them of having more severe consequences</p>
					</div>
				</div>
